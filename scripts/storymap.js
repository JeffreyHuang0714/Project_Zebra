$(window).on('load', function() {
  ...
  */
   ...
   */
  function addBaseMap() {
    let OpenStreetMap_Mapnik = L.tileLayer('https://api.mapbox.com/styles/v1/mingruihuang/cktakj3dg6sdb17lpomyyqbtp/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWluZ3J1aWh1YW5nIiwiYSI6ImNrdGFrZmNuOTFuN3MycXA0b2Q0eGhxOHUifQ.FFEWESFqX_rTrQC_vr_PmQ', {
       maxZoom: 19,
